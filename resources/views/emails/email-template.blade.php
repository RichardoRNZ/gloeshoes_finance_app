                            ...
                            <tr width="640" style="width: 640px; min-width: 640px; " align="center">
                                        ...
                                        <tr width="640" style="width: 640px; min-width: 640px; " align="center">
                                            <td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="640"
                                                    ...
                                                    align="center" bgcolor="#4f48e0">
                                                    <tr>
                                                        <td align="left">
                                                            <table cellpadding="0" cellspacing="0" border="0"
                                                                role="presentation" align="center" bgcolor="#4f48e0">
                                                                <tr>
                                                                    <td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left"
                                                style="color:#45535C;padding:40px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:500;font-size:15px;-webkit-font-smoothing:antialiased;line-height:1.2;"
                                                class="table-container">
                                                Hai {{ $customerName }},
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                ...
                                                class="table-container">
                                                Pesanan anda telah kami proses dan akan segera kami kirimkan. Mohon
                                ...
                                <table bgcolor="#4f48e0" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <table bgcolor="#4f48e0" cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tr>
                                        <td
                                            style="color:#fff; font-size:14px; line-height:22px; text-align:center;border:none;font-weight:bold;">
                                            Malang, Jawa Timur, Indonesia <br>
                                            © 2024 Gloeshoes Leather <br>
                                        </td>
                                    </tr>
                                </table>
                                <table bgcolor="#4f48e0" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0"
                                    align="center" width="640" style="width: 640px; min-width: 640px;"
                                    role="presentation" class="table-container ">
                                    <tr>
                                ...
                                <table align="center" border="0" bgcolor="#f1f1f1" cellpadding="0"
                                    cellspacing="0" width="640" role="presentation" class="table-container ">
                                    <tbody>
